describe('AddProduct is the page that there is a form of inputs of properties of a product.', function () {
    var ProductService;
    var element;
    var comp = '<add-product></add-product>';
    var $scope, $compile;
    var $q;
    var ctrl;

    const SELECTOR_MESSAGE_NAME= "div[ng-messages='$ctrl.addProductForm.Name.$error']";
    const SELECTOR_MESSAGE_DETAIL= "div[ng-messages='$ctrl.addProductForm.Detail.$error']";
    const SELECTOR_MESSAGE_NUMBER= "div[ng-messages='$ctrl.addProductForm.Number.$error']";
    ...
    it('the `addProduct` method of `ProductService` should be triggered when form is submitted', (done)=>{ 
     ...
     it('should show success message when the submit is correct', (done) => {   
        ...
        spyOn(ProductService, 'addProduct').and.callFake(()=>{
         ...
         var div= element.find("#response");
         var SUCCESS_MESSAGE="Success!";    
         expect(angular.element(div).html()).toContain(SUCCESS_MESSAGE);
     });
